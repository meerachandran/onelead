    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch', models.ForeignKey(to='leaddb.Batch')),
            ],
            options=None,
            bases=None,
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('batch', models.ForeignKey(to='leaddb.Batch')),
                ('subject', models.ForeignKey(to='leaddb.Subject')),
            ],
            options=None,
            bases=None,
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.CharField(max_length=200)),
                ('batch', models.ForeignKey(to='leaddb.Batch')),
                ('event', models.ForeignKey(to='leaddb.EventTypes')),
                ('responsible_staff', models.ForeignKey(to='leaddb.Staff')),
            ],
            options=None,
            bases=None,
        ),
        migrations.AddField(
            ...
            name='staff',
            field=models.ForeignKey(to='leaddb.Staff'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='mentorship',
            name='student',
            field=models.ForeignKey(to='leaddb.Student'),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(to='leaddb.TimeTable'),
            preserve_default=True,
        ),
    ]
