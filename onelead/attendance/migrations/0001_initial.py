    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch', models.ForeignKey(to='attendance.Batch')),
            ],
            options=None,
            bases=None,
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('batch', models.ForeignKey(to='attendance.Batch')),
                ('subject', models.ForeignKey(to='attendance.Subject')),
            ],
            options=None,
            bases=None,
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.CharField(max_length=200)),
                ('batch', models.ForeignKey(to='attendance.Batch')),
                ('event', models.ForeignKey(to='attendance.EventTypes')),
                ('responsible_staff', models.ForeignKey(to='attendance.Staff')),
            ],
            options=None,
            bases=None,
        ),
        migrations.AddField(
            ...
            name='staff',
            field=models.ForeignKey(to='attendance.Staff'),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(to='attendance.TimeTable'),
            preserve_default=True,
        ),
    ]
